...
module.exports = (Encore) => {
    ...
    Encore.addEntry('toolbar_scripts_js', [
        path.resolve('./vendor/ezsystems/ezplatform-admin-ui/src/bundle/Resources/public/js/scripts/helpers/request.helper.js'),
        path.resolve('./vendor/ezsystems/ezplatform-admin-ui/src/bundle/Resources/public/js/scripts/helpers/notification.helper.js'),
